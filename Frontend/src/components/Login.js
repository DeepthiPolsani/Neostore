                ...
                <Container className="conatiner mt-3 mb-5">
                    <Row>
                        ...
                        Email
                                ...
                                <Button variant="success" onClick={login} className='bb col-lg-4 '>Login</Button>

                            </Form>
                        </Col>
                    </Row>
                    <div class="text-center mt-4">
                        <Button variant="light" type="submit" href="/register" className="ml-2 cc" >Register Now</Button>
                        <Button variant="light" type="submit" href="/forgotpassword" className="ml-2 cc" >Forgot Password</Button>
                    </div>
                </Container>
