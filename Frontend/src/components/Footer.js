            ...
            <div className='bg-dark footer p-5'>
                <Row>
                    ...
                    <ul className='list-unstyled'><h4>About Company</h4>
                        ...
                        <li><a href="" target="_blank" style={{textDecoration:'none',color:'white'}}>Email : contact@neosofttech.com</a></li>
                        <li><a href="" target="_blank" style={{textDecoration:'none',color:'white'}}>Phone : +91 0000000000</a></li>
                        <li>Mumbai, India</li>
                    </ul>
                    </Col>
                    <Col style={{color:'white'}}>
                    ...
                    <ul className='list-unstyled'><h4>News Letter</h4>
                        ...
                        <li><input type="text" placeholder='Your Email...'></input></li>
                        <br/>
