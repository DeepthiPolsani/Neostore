    ...
    return (
        ...
        <Container className="mt-4 ">
         <div class="row d-flex justify-content-center col-sm-12">
                        <div class=" col-md-3 col-sm-12 col-lg-4 mb-3 mr-20 w-100"> <a href="#" className="w-100 facebook"> 
                            <SocialButton
                                 className="btn btn-primary col-lg-8 p-2 mb-3 cc"

                                 provider="facebook"
                                 appId="607344287133237"
                                 onLoginSuccess={handleSocialLogin}
                                 onLoginFailure={handleSocialLoginFailure}
                            >
                                <i className="mr-3  w-80"><Icon.Facebook size={25}  /></i><span>Login with facebook</span>
                              
                            </SocialButton>  </a> </div>
                        <div class="col-md-3 col-sm-12 col-lg-4"> <a href="#" className=" google-plus"> 
                        <SocialButton
                                className="btn btn-danger col-lg-8 p-2 mb-3 cc"
                                provider="google"
                                appId="639288633630-g8peo9jkkrc0rs3jo3n12cko585a60rp.apps.googleusercontent.com"
                                onLoginSuccess={handleSocialLogin}
                                onLoginFailure={handleSocialLoginFailure}
                            >
                        <i className="mr-3 w-80"><Icon.Google size={25} /></i><span>Login with google</span>
                        </SocialButton>  </a> </div>
                    </div>
            <Container className="mt-3 w-75 bg-light p-4">
                ...
                <Form >
                    ...
                    <Row>
                        ...
                        <Form.Group className="mb-3">
                        <Form.Label className="pr-2">Gender:</Form.Label>  
                    ...
                    <Button variant="success" onClick={register} className='bb'>Register</Button>
                    <Button variant="warning" type="submit" href="/login" className="ml-3 bb"> Login</Button>
                </Form>
            </Container>
        </Container>
        </>
